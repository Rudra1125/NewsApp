  ...
  render() {
    return (
      ...
      />
          ...
          <Route exact path="business" element={<News setProgress= {this.setProgress} apiKey={this.apiKey} key="buisness" pageSize={this.pageSize} country="in" category="business" />}></Route>
          ...
          <Route exact path="politics" element={<News setProgress= {this.setProgress} apiKey={this.apiKey} key="politics" pageSize={this.pageSize} country="in" category="politics" />}></Route>
          </Routes>
        </Router>
