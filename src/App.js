    ...
    return (
      <div>
        ...
        <Router>  
          ...
          <Route exact path="business" element={<News key="buisness" pageSize={6} country="in" category="business" />}></Route>
          ...
          <Route exact path="politics" element={<News key="politics" pageSize={6} country="in" category="politics" />}></Route>
          </Routes>
        </Router>
